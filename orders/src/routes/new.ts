...
import { BadRequestError, NotFoundError, OrderStatus, requireAuth, validateRequest } from '@common_v2/common';
...
router.post('/api/orders',
    ...
    async (req: Request, res: Response) => {
        ...
        // is the ticket we just foud *and* the orders status is *not* cancelled
